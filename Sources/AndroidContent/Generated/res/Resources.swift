...
open class Resources: Object {
  ...
  open func getText(id: Int32) -> String? {
    self.javaObject.call(method: Resources__method__1, [id.toJavaParameter()])
  }

  open func getQuantityText(id: Int32, quantity: Int32) -> String? {
    self.javaObject.call(method: Resources__method__2, [id.toJavaParameter(), quantity.toJavaParameter()])
  }

  open func getString(id: Int32) -> String {
    self.javaObject.call(method: Resources__method__3, [id.toJavaParameter()])
  }

  open func getString(id: Int32, formatArgs: [Object?]) -> String {
    self.javaObject.call(method: Resources__method__4, [id.toJavaParameter(), formatArgs.toJavaParameter()])
  }

  open func getQuantityString(id: Int32, quantity: Int32, formatArgs: [Object?]) -> String {
    self.javaObject.call(method: Resources__method__5, [id.toJavaParameter(), quantity.toJavaParameter(), formatArgs.toJavaParameter()])
  }

  open func getQuantityString(id: Int32, quantity: Int32) -> String {
    self.javaObject.call(method: Resources__method__6, [id.toJavaParameter(), quantity.toJavaParameter()])
  }

  open func getText(id: Int32, def: String?) -> String? {
    self.javaObject.call(method: Resources__method__7, [id.toJavaParameter(), def.toJavaParameter()])
  }

  open func getTextArray(id: Int32) -> [String?] {
    self.javaObject.call(method: Resources__method__8, [id.toJavaParameter()])
  }

  open func getStringArray(id: Int32) -> [String] {
    self.javaObject.call(method: Resources__method__9, [id.toJavaParameter()])
  }

  open func getIntArray(id: Int32) -> [Int32] {
    self.javaObject.call(method: Resources__method__10, [id.toJavaParameter()])
  }

  open func obtainTypedArray(id: Int32) -> TypedArray? {
    self.javaObject.call(method: Resources__method__11, [id.toJavaParameter()])
  }

  open func getDimension(id: Int32) -> Float {
    self.javaObject.call(method: Resources__method__12, [id.toJavaParameter()])
  }

  open func getDimensionPixelOffset(id: Int32) -> Int32 {
    self.javaObject.call(method: Resources__method__13, [id.toJavaParameter()])
  }

  open func getDimensionPixelSize(id: Int32) -> Int32 {
    self.javaObject.call(method: Resources__method__14, [id.toJavaParameter()])
  }

  open func getFraction(id: Int32, base: Int32, pbase: Int32) -> Float {
    self.javaObject.call(method: Resources__method__15, [id.toJavaParameter(), base.toJavaParameter(), pbase.toJavaParameter()])
  }

  open func getColor(id: Int32, theme: Resources.Theme?) -> Int32 {
    self.javaObject.call(method: Resources__method__16, [id.toJavaParameter(), theme.toJavaParameter()])
  }

  open func getColorStateList(id: Int32, theme: Resources.Theme?) -> ColorStateList? {
    self.javaObject.call(method: Resources__method__17, [id.toJavaParameter(), theme.toJavaParameter()])
  }

  open func getBoolean(id: Int32) -> Bool {
    self.javaObject.call(method: Resources__method__18, [id.toJavaParameter()])
  }

  open func getInteger(id: Int32) -> Int32 {
    self.javaObject.call(method: Resources__method__19, [id.toJavaParameter()])
  }

  open func getLayout(id: Int32) -> XmlResourceParser? {
    let res = self.javaObject.call(method: Resources__method__20, [id.toJavaParameter()]) as Object?
    return cast(res, to: XmlResourceParserProxy.self)
  }

  open func getAnimation(id: Int32) -> XmlResourceParser? {
    let res = self.javaObject.call(method: Resources__method__21, [id.toJavaParameter()]) as Object?
    return cast(res, to: XmlResourceParserProxy.self)
  }

  open func getXml(id: Int32) -> XmlResourceParser? {
    let res = self.javaObject.call(method: Resources__method__22, [id.toJavaParameter()]) as Object?
    return cast(res, to: XmlResourceParserProxy.self)
  }

  open func openRawResourceFd(id: Int32) -> AssetFileDescriptor? {
    self.javaObject.call(method: Resources__method__23, [id.toJavaParameter()])
  }

  public func newTheme() -> Resources.Theme? {
    self.javaObject.call(method: Resources__method__24, [])
  }

  open func getConfiguration() -> Configuration? {
    self.javaObject.call(method: Resources__method__25, [])
  }

  open func getIdentifier(name: String, defType: String, defPackage: String) -> Int32 {
    self.javaObject.call(method: Resources__method__26, [name.toJavaParameter(), defType.toJavaParameter(), defPackage.toJavaParameter()])
  }

  open func getResourceName(resid: Int32) -> String {
    self.javaObject.call(method: Resources__method__27, [resid.toJavaParameter()])
  }

  open func getResourcePackageName(resid: Int32) -> String {
    self.javaObject.call(method: Resources__method__28, [resid.toJavaParameter()])
  }

  open func getResourceTypeName(resid: Int32) -> String {
    self.javaObject.call(method: Resources__method__29, [resid.toJavaParameter()])
  }

  open func getResourceEntryName(resid: Int32) -> String {
    self.javaObject.call(method: Resources__method__30, [resid.toJavaParameter()])
  }

  open func parseBundleExtras(parser: XmlResourceParser?, outBundle: Bundle?) {
    self.javaObject.call(method: Resources__method__31, [JavaParameter(object: parser?.toJavaObject()), outBundle.toJavaParameter()])
  }

  public func getAssets() -> AssetManager? {
    self.javaObject.call(method: Resources__method__32, [])
  }

  public func flushLayoutCache() {
    self.javaObject.call(method: Resources__method__33, [])
  }
...
open class ResourcesTheme: Object {
  ...
  open func dump(priority: Int32, tag: String, prefix: String) {
...
private let Resources__method__16 = Resources__class.getMethodID(name: "getColor", sig: "(ILandroid/content/res/Resources$Theme;)I")!
private let Resources__method__17 = Resources__class.getMethodID(name: "getColorStateList", sig: "(ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;")!
private let Resources__method__18 = Resources__class.getMethodID(name: "getBoolean", sig: "(I)Z")!
private let Resources__method__19 = Resources__class.getMethodID(name: "getInteger", sig: "(I)I")!
private let Resources__method__20 = Resources__class.getMethodID(name: "getLayout", sig: "(I)Landroid/content/res/XmlResourceParser;")!
private let Resources__method__21 = Resources__class.getMethodID(name: "getAnimation", sig: "(I)Landroid/content/res/XmlResourceParser;")!
private let Resources__method__22 = Resources__class.getMethodID(name: "getXml", sig: "(I)Landroid/content/res/XmlResourceParser;")!
private let Resources__method__23 = Resources__class.getMethodID(name: "openRawResourceFd", sig: "(I)Landroid/content/res/AssetFileDescriptor;")!
private let Resources__method__24 = Resources__class.getMethodID(name: "newTheme", sig: "()Landroid/content/res/Resources$Theme;")!
private let Resources__method__25 = Resources__class.getMethodID(name: "getConfiguration", sig: "()Landroid/content/res/Configuration;")!
private let Resources__method__26 = Resources__class.getMethodID(name: "getIdentifier", sig: "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I")!
private let Resources__method__27 = Resources__class.getMethodID(name: "getResourceName", sig: "(I)Ljava/lang/String;")!
private let Resources__method__28 = Resources__class.getMethodID(name: "getResourcePackageName", sig: "(I)Ljava/lang/String;")!
private let Resources__method__29 = Resources__class.getMethodID(name: "getResourceTypeName", sig: "(I)Ljava/lang/String;")!
private let Resources__method__30 = Resources__class.getMethodID(name: "getResourceEntryName", sig: "(I)Ljava/lang/String;")!
private let Resources__method__31 = Resources__class.getMethodID(name: "parseBundleExtras", sig: "(Landroid/content/res/XmlResourceParser;Landroid/os/Bundle;)V")!
private let Resources__method__32 = Resources__class.getMethodID(name: "getAssets", sig: "()Landroid/content/res/AssetManager;")!
private let Resources__method__33 = Resources__class.getMethodID(name: "flushLayoutCache", sig: "()V")!
private let Resources__method__34 = Resources__class.getMethodID(name: "finishPreloading", sig: "()V")!
