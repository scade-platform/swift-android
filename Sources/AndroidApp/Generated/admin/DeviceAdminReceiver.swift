...
open class DeviceAdminReceiver: Object, BroadcastReceiver {
  ...
  open func onDisableRequested(context: Context?, intent: Intent?) -> String? {
  ...
  open func onDisabled(context: Context?, intent: Intent?) {
  ...
  open func onPasswordChanged(context: Context?, intent: Intent?) {
  ...
  open func onPasswordFailed(context: Context?, intent: Intent?) {
  ...
  open func onPasswordSucceeded(context: Context?, intent: Intent?) {
  ...
  open func onPasswordExpiring(context: Context?, intent: Intent?) {
  ...
  open func onProfileProvisioningComplete(context: Context?, intent: Intent?) {
  ...
  open func onLockTaskModeEntering(context: Context?, intent: Intent?, pkg: String) {
    self.javaObject.call(method: DeviceAdminReceiver__method__11, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter(), pkg.toJavaParameter()])
  }

  open func onLockTaskModeExiting(context: Context?, intent: Intent?) {
    self.javaObject.call(method: DeviceAdminReceiver__method__12, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter()])
  }

  open func onSystemUpdatePending(context: Context?, intent: Intent?, receivedTime: Int64) {
    self.javaObject.call(method: DeviceAdminReceiver__method__13, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter(), receivedTime.toJavaParameter()])
  }

  open func onBugreportSharingDeclined(context: Context?, intent: Intent?) {
    self.javaObject.call(method: DeviceAdminReceiver__method__14, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter()])
  }

  open func onBugreportShared(context: Context?, intent: Intent?, bugreportHash: String) {
    self.javaObject.call(method: DeviceAdminReceiver__method__15, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter(), bugreportHash.toJavaParameter()])
  }

  open func onBugreportFailed(context: Context?, intent: Intent?, failureCode: Int32) {
    self.javaObject.call(method: DeviceAdminReceiver__method__16, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter(), failureCode.toJavaParameter()])
  }

  open func onSecurityLogsAvailable(context: Context?, intent: Intent?) {
    self.javaObject.call(method: DeviceAdminReceiver__method__17, [JavaParameter(object: context?.toJavaObject()), intent.toJavaParameter()])
  }
...
private let DeviceAdminReceiver__method__11 = DeviceAdminReceiver__class.getMethodID(name: "onLockTaskModeEntering", sig: "(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V")!
private let DeviceAdminReceiver__method__12 = DeviceAdminReceiver__class.getMethodID(name: "onLockTaskModeExiting", sig: "(Landroid/content/Context;Landroid/content/Intent;)V")!
private let DeviceAdminReceiver__method__13 = DeviceAdminReceiver__class.getMethodID(name: "onSystemUpdatePending", sig: "(Landroid/content/Context;Landroid/content/Intent;J)V")!
private let DeviceAdminReceiver__method__14 = DeviceAdminReceiver__class.getMethodID(name: "onBugreportSharingDeclined", sig: "(Landroid/content/Context;Landroid/content/Intent;)V")!
private let DeviceAdminReceiver__method__15 = DeviceAdminReceiver__class.getMethodID(name: "onBugreportShared", sig: "(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V")!
private let DeviceAdminReceiver__method__16 = DeviceAdminReceiver__class.getMethodID(name: "onBugreportFailed", sig: "(Landroid/content/Context;Landroid/content/Intent;I)V")!
private let DeviceAdminReceiver__method__17 = DeviceAdminReceiver__class.getMethodID(name: "onSecurityLogsAvailable", sig: "(Landroid/content/Context;Landroid/content/Intent;)V")!
private let DeviceAdminReceiver__method__18 = DeviceAdminReceiver__class.getMethodID(name: "onReceive", sig: "(Landroid/content/Context;Landroid/content/Intent;)V")!
