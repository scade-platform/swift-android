...
open class MediaExtractor: Object {
  ...
  open func readSampleData(byteBuf: ByteBuffer?, offset: Int32) -> Int32 {
    self.javaObject.call(method: MediaExtractor__method__16, [JavaParameter(object: byteBuf?.toJavaObject()), offset.toJavaParameter()])
  }
  ...
  open func getSampleFlags() -> Int32 {
    self.javaObject.call(method: MediaExtractor__method__19, [])
  }

  open func getSampleCryptoInfo(info: MediaCodec.CryptoInfo?) -> Bool {
    self.javaObject.call(method: MediaExtractor__method__20, [info.toJavaParameter()])
  }
  ...
  open func hasCacheReachedEndOfStream() -> Bool {
    self.javaObject.call(method: MediaExtractor__method__22, [])
  }
...
extension MediaExtractor {
  open func getPsshInfo() -> MapProxy<UUID, [Int8]>? {
    self.javaObject.call(method: MediaExtractor__method__10, [])
  }
}
...
private let MediaExtractor__method__16 = MediaExtractor__class.getMethodID(name: "readSampleData", sig: "(Ljava/nio/ByteBuffer;I)I")!
private let MediaExtractor__method__17 = MediaExtractor__class.getMethodID(name: "getSampleTrackIndex", sig: "()I")!
private let MediaExtractor__method__18 = MediaExtractor__class.getMethodID(name: "getSampleTime", sig: "()J")!
private let MediaExtractor__method__19 = MediaExtractor__class.getMethodID(name: "getSampleFlags", sig: "()I")!
private let MediaExtractor__method__20 = MediaExtractor__class.getMethodID(name: "getSampleCryptoInfo", sig: "(Landroid/media/MediaCodec$CryptoInfo;)Z")!
private let MediaExtractor__method__21 = MediaExtractor__class.getMethodID(name: "getCachedDuration", sig: "()J")!
private let MediaExtractor__method__22 = MediaExtractor__class.getMethodID(name: "hasCacheReachedEndOfStream", sig: "()Z")!
